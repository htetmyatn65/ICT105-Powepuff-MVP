...
|---|---|---|---|
| Nichaphat Leamviset | Basic HTML | Canva | Presentation |
| Swe Zin win | JavaScript beginner | Basic HTML | Team coordination |
| Htet Myat Noe | Spreadsheet | Google Survey | Interview questions |
## Team Working Agreement
1. Meeting schedule: Every time when it's neecessary
